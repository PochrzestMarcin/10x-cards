...
describe("FlashcardModal", () => {
  ...
  describe("Create Mode", () => {
    it("renders create modal with empty form", () => {
      render(<FlashcardModal isOpen={true} mode="create" flashcard={null} onSave={mockOnSave} onClose={mockOnClose} />);
  ...
  describe("Edit Mode", () => {
    it("renders edit modal with populated form", () => {
      render(
        <FlashcardModal isOpen={true} mode="edit" flashcard={mockFlashcard} onSave={mockOnSave} onClose={mockOnClose} />
      );
    ...
    it("handles ai-full source conversion to ai-edited", async () => {
      ...
      render(
        <FlashcardModal isOpen={true} mode="edit" flashcard={aiFlashcard} onSave={mockOnSave} onClose={mockOnClose} />
      );
